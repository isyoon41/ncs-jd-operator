        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          ...
          <div className="space-y-5">
            ...
            <div className="grid gap-5 lg:grid-cols-2">
              <Field label="회사 소개 직접 입력" hint={currentProfile ? "선택 · 새 프로필 생성" : "자료가 없으면 필수"}><textarea name="companyIntroduction" rows={9} className={inputClass} placeholder="예: 퓨리오젠은 바이오의약품 개발 기업을 대상으로 연구용 원료와 기술 솔루션을 제공하고 있습니다. 주요 고객은 국내 제약·바이오 연구소이며…" maxLength={30000} /></Field>
